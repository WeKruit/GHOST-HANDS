...
ABSOLUTE RULE #2 — FULLY VISIBLE ONLY: If ANY part of a field, dropdown button, question text, or input box is cut off at the top or bottom edge of the screen, it is NOT fully visible — DO NOT interact with it at all. Only touch fields where the ENTIRE element is within the viewport. When in doubt, skip it.
...
If ALL visible fields already have values, STOP IMMEDIATELY — do nothing. Do not "fix" fields. Do not re-type values. Do not use keyboard shortcuts. Do NOT click "Submit" or "Save and Continue".
...
If ALL visible fields already have values, STOP IMMEDIATELY — do nothing. Do NOT click "Submit" or "Save and Continue".
...
If ALL visible questions already have answers, STOP IMMEDIATELY. Do NOT click "Submit" or "Save and Continue".`;
...
If ALL fields already have values or no form fields exist, STOP IMMEDIATELY. Do NOT click "Submit" or "Save and Continue".
