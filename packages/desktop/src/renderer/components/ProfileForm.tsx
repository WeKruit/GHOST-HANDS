...
const emptyEducation: EducationEntry = { school: '', degree: '', field: '', startYear: 2020 };
        ...
        <div key={i} style={styles.subCard}>
          ...
          <div style={styles.row}>
            ...
            <div style={{ ...styles.field, maxWidth: 100 }}>
              ...
              <input style={styles.input} type="number" value={edu.startYear} onChange={(e) => updateEducation(i, 'startYear', Number(e.target.value))} />
            </div>
            <div style={{ ...styles.field, maxWidth: 100 }}>
              <label style={styles.label}>End Year</label>
              <input style={styles.input} type="number" value={edu.endYear || ''} onChange={(e) => updateEducation(i, 'endYear', e.target.value ? Number(e.target.value) : undefined)} placeholder="present" />
            </div>
          </div>
