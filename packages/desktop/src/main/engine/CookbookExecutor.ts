 ...
 *
 * Copied from packages/ghosthands/src/engine/CookbookExecutor.ts for bundling isolation.
 * LogEventCallback is inlined to avoid importing from events/.
 */
...
/** Inlined from JobEventTypes to avoid cross-package import. */
...
export interface CookbookExecutorOptions {
  ...
  /** Optional callback to log events */
