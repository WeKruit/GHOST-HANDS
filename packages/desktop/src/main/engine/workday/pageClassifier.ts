 ...
 */
export async function detectPage(adapter: MinimalAdapter): Promise<PageState> {
 ...
 */
async function classifyPageFromDOM(adapter: MinimalAdapter): Promise<PageState['page_type']> {
 ...
 */
export async function isActuallyReview(adapter: MinimalAdapter): Promise<boolean> {
  return adapter.page.evaluate(() => {
